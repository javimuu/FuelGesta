<?php echo render($partial_dir . '_titre_activites.php'); ?>
    ...
    <fieldset>
        ...
        <a href="ajouter_activite" class="btn btn-success pull-right"><i class="icon-white icon-plus"></i> Ajouter une
            activité</a>
                ...
                <tr id="<?php echo $value->id_activite ?>">
                    ...
                    <td class="text-right">
                        <a class="btn btn-mini btn-warning"
                           href="<?php echo Uri::create($view_dir . 'modifier_activite/' . $value->id_activite); ?>"> <i
