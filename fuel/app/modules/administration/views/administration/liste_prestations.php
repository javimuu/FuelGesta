...
<fieldset>
    ...
    <a href="../ajouter_heures_prestation/<?php echo $groupe; ?>" class="btn btn-success pull-right"><i class="icon-ok icon-white"></i> Ajouter des prestations</a>
...
<!--    <a href="../ajouter_jours_prestation/--><?php //echo $groupe; ?><!--" class="btn btn-success pull-right"><i class="icon-ok icon-white"></i>Ajouter des jours</a>-->
    ...
    <table class="table table-top table-striped">
        ...
        <tr style="text-align: center">
            ...
            <td class="text-right">
                <?php echo Html::anchor('administration/modifier_heures_prestation/'.$heure->id_heures_prestations, '<i class="icon-edit icon-white"></i>',array('class'=>'btn btn-mini btn-warning')) ?>
                <?php echo Html::anchor('administration/supprimer_heures_prestation/'.$heure->id_heures_prestations, '<i class="icon-remove icon-white"></i>', array('onclick' => "return confirm('Etes-vous sûr de vouloir supprimer cette prestation ?')",'class'=>'btn btn-mini btn-danger')) ?>
            </td>
        </tr>    
        <?php
...
<?php echo Html::anchor('administration/prestations', '<i class="icon-arrow-left"></i> Retour', array('class' => "btn btn-sucess pull-right")); ?>
<div class="clear"></div>