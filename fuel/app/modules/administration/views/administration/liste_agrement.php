...
<fieldset>
    ...
    <a href="<?php echo Uri::create('administration/ajouter_agrement/') ?>" class="btn btn-success pull-right"><i class="icon-white icon-plus"></i>Ajouter
        un agrément</a>
    ...
    <table class="table table-striped table-top" id="table_activite">
        ...
        <tr id="<?php echo $agrements->id_agrement ?>">
            ...
            <td class="text-right">
                ...
                <a class="btn btn-mini btn-danger" href="<?php echo Uri::create('administration/supprimer_agrement/'.$agrements->id_agrement); ?>" onclick="return confirm('Etes-vous sûr de vouloir supprimer cet agrément ?')"><i class="icon-remove-sign icon-white"></i></a>
            </td>
        </tr>    
        <?php
        endforeach;
