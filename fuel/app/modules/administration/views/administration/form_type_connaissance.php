<h2>Connaissance de l'EFT</h2>

<?php echo Form::open(array('class' => 'form-horizontal')); ?>

<fieldset>
    
    <legend><?php echo $action; ?> un type de connaissance</legend>
...
<?php echo render($partial_dir.'_back.php', array('url' => Uri::create($view_dir.'liste_types_connaissance'))); ?>