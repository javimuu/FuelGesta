...
<fieldset>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo Form::select('users_id', Input::post('users_id', isset($agrement) ? $agrement->users->id : ''), $users); ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo Form::select('centre_id', Input::post('centre_id', isset($agrement) ? $agrement->centres->id_centre : ''), $centre); ?>
        </div>
    </div>
    ...
    <?php echo render($partial_dir . '/_back.php', array('url' => Uri::create($view_dir . 'liste_agrement'))); ?>
