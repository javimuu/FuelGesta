...
<fieldset>
    <legend><?php echo $action; ?> un centre</legend>
            ...
            <td>
                <table class="form-left">
                    <tr>
                        <td>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                <?php echo Form::select('t_responsable', Input::post('t_responsable', isset($centre) ? $centre->t_responsable : ''), $user); ?>
                                </div>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <div class="control-group">
                                <?php echo Form::label('Nom abrégé', 't_nom_centre', array('class' => 'control-label')); ?>
                                <div class="controls">
                    ...
                    <tr>
                        <td>
                            <div class="control-group">
                                <?php echo Form::label('Agréation Marchés Publics', 't_agregation', array('class' => 'control-label')); ?>
                                <div class="controls">
                    ...
                    <tr>
                        <td>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                <?php echo Form::select('t_responsable_pedagogique', Input::post('t_responsable_pedagogique', isset($centre) ? $centre->t_responsable_pedagogique : ''), $user); ?>
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                <?php echo Form::select('t_secretaire', Input::post('t_secretaire', isset($centre) ? $centre->t_secretaire : ''), $user); ?>
                                </div>
                            </div>
                        </td>
                    </tr>
