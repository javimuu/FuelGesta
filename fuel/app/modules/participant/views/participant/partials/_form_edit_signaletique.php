                ...
                <tr>
                    <td>
                        <div class="control-group">
                            ...
                            <div class="controls">
                            <?php echo Form::input('d_date_naissance', Input::post('d_date_naissance', isset($participant) ? \Maitrepylos\Date::db_to_date($participant->d_date_naissance) : ''), array('placeholder' => 'dd/mm/yyyy')); ?>
                            <span id="age"></span>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    <td>
                        <div class="control-group">
                            ...
                            <div class="controls">
                            <?php echo Form::select('t_nationalite', Input::post('t_nationalite', isset($participant) ? $participant->t_nationalite : ''), $nationalite) ?>
                            </div>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <td>
                        <div class="control-group">
                            ...
                            <div class="controls">
                            <?php echo Form::select('t_etat_civil', Input::post('t_etat_civil', isset($participant) ? $participant->t_etat_civil : ''), array('' => '', 'Célibataire' => 'Célibataire', 'Marié(e)' => 'Marié(e)',  'Divorcé(e)' => 'Divorcé(e)', 'Veuf(ve)' => 'Veuf(ve)')); ?>
                            </div>
                        </div>
                    </td>
                </tr>
