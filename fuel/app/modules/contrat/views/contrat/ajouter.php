...
<h3>Liste des contrats
    de <?php echo Html::anchor('participant/modifier/' . $participant->id_participant, $participant->t_nom . ' ' . $participant->t_prenom) ?>
    -
...
<?php if ($viewcontrat != Null): ?>
    <table class="tablesorter table table-striped ">
        ...
        <tr>
            ...
            <th></th>
            <th>TOTAL</th>
            <th><?php echo $time->TimeToString($total) ?></th>
            <th></th>
            <th></th>
